...
echo 'The logo path is:'.$LogoPath.'<br />';
...
<div style="float: left; margin-left: auto; margin-right: auto; width: 64%; ">		
	...
	<span class="feedback-text">Accessibility questions: Click <a href="mailto:plkoch@wisc.edu">here</a> to send an email</span><br /><br />
